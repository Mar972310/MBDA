...
--LABORATORIO 6
    ...
    --POBLAROK
        INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
        VALUES ('P180812345078', TO_DATE('2023-10-05', 'YYYY-MM-DD'), TO_DATE('2023-10-10', 'YYYY-MM-DD'), '
			<TDescripcion>
			  <Asunto>No lo se</Asunto>
			  <Descripcion>Hola</Descripcion>
              <Notificaciones>
                  <Notificacion>
                      <Prioridad>1</Prioridad>
                      <TipoMedio>Correo Electronico</TipoMedio>
                      <Valor>1456</Valor>
                      <Notificacion>
                      <Prioridad>3</Prioridad>
                      <TipoMedio>Web</TipoMedio>
                      <Valor>10</Valor>
                  </Notificacion>
                  </Notificacion>
              </Notificaciones>
			</TDescripcion>', 'P', 'P', 1808);
        
        INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
        VALUES ('P280816345678', TO_DATE('2023-10-06', 'YYYY-MM-DD'), TO_DATE('2023-10-12', 'YYYY-MM-DD'), '
			<TDescripcion>
            ...
            </TDescripcion>', 'P', 'P', 2808);
        
        INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
        VALUES ('P380812345578', TO_DATE('2023-10-07', 'YYYY-MM-DD'), TO_DATE('2023-10-15', 'YYYY-MM-DD'), '
			<TDescripcion>
			  <Asunto>Proceso de cobro invalido</Asunto>
			  <Descripcion>Hola</Descripcion>
              <Notificaciones>
                  <Notificacion>
                      <Prioridad>1</Prioridad>
        ...
        SELECT
            ticked AS "Número de Ticket",
            extractValue(descripcion, '/TDescripcion/Asunto') AS "Asunto",
            radicacion AS "Fecha de Registro"
        FROM
            PQRS
        WHERE
            EXTRACT(YEAR FROM cierre) = EXTRACT(YEAR FROM SYSDATE) AND
            EXTRACTVALUE(descripcion, '/TDescripcion/Notificaciones/Notificacion/Prioridad/text()') = '1' AND
            EXTRACTVALUE(descripcion, '/TDescripcion/Notificaciones/Notificacion/TipoMedio/text()') = 'Correo Electronico'
        ORDER BY
            radicacion DESC;

-------------Consulta propuesta----
SELECT
    ticked AS "Número de Ticket",radicacion AS "Fecha de Registro",
    extractValue(descripcion, '/TDescripcion/Asunto') AS "Asunto"
FROM
    PQRS
WHERE
        LOWER(extractValue(descripcion, '/TDescripcion/Asunto')) LIKE '%conductor%'
    ORDER BY
        radicacion DESC;
---------------insert para el DTD extendido-------------------------
-- Primer INSERT
INSERT INTO PQRS (ticked, radicacion, cierre, descripcion, tipo, estado, solicitud)
VALUES (
    'P180892345078',
    ...
    <TDescripcion>
        ...
        <Notificaciones>
            <Notificacion>
                ...
                <TipoMedio>Correo Electrónico</TipoMedio>
                <Valor>1456</Valor>
            </Notificacion>
        </Notificaciones>
    </TDescripcion>',
...
VALUES (
    ...
    <TDescripcion>
        ...
        <Encargado>
            ...
            <!-- No se incluye el campo opcional Teléfono -->
        </Encargado>
        <Notificaciones>
            <Notificacion>
                <Prioridad>Alta</Prioridad>
...
----------------------------consulta dtd extendido-----------

SELECT
    extractValue(descripcion, '/TDescripcion/Encargado/Nombre') AS "Remitente",
    COUNT(*) AS "Cantidad de PQRS"
FROM
    PQRS
GROUP BY
    extractValue(descripcion, '/TDescripcion/Encargado/Nombre')
ORDER BY
    COUNT(*) DESC;
